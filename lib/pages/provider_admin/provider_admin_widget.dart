...
import 'provider_admin_model.dart';
export 'provider_admin_model.dart';

class ProviderAdminWidget extends StatefulWidget {
  const ProviderAdminWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ProviderAdminWidget> createState() => _ProviderAdminWidgetState();
}

class _ProviderAdminWidgetState extends State<ProviderAdminWidget> {
  late ProviderAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderAdminModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.publishDoc != null) {
        ...
        setState(() {
          _model.priceTextController?.text = widget.publishDoc!.dailyRate;
          _model.priceTextController?.selection = TextSelection.collapsed(
              offset: _model.priceTextController!.text.length);
        });
      }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '178noewt' /* Service administratif */,
                              ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  options: [
                                    ...
                                    FFLocalizations.of(context).getText(
                                      'stuk4u1h' /* Permis de travail */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'c7wx13u3' /* Papiers administratifs */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'kl4zgr5q' /* Autre */,
                                    )
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'm2bkqii8' /* Précisez vos compétences */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleLarge
                                      .override(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'webbumh1' /* Nombre d’années d’expériences.... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnProviderWidget(
                  ...
                  parameter4: _model.priceTextController.text,
                  parameter5: _model.priceTextController.text,
                  publishDoc: widget.publishDoc,
                  categoryName: 'Service administratif',
                  categoryImage:
