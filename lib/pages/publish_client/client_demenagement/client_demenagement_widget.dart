...
import 'client_demenagement_model.dart';
export 'client_demenagement_model.dart';

class ClientDemenagementWidget extends StatefulWidget {
  const ClientDemenagementWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ClientDemenagementWidget> createState() =>
      _ClientDemenagementWidgetState();
}

class _ClientDemenagementWidgetState extends State<ClientDemenagementWidget> {
  late ClientDemenagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientDemenagementModel());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          options: [
                            FFLocalizations.of(context).getText(
                              '6benhf4g' /* Déménagement */,
                            ),
                            FFLocalizations.of(context).getText(
                              'c2z553qd' /* Montage meubles */,
                            ),
                            FFLocalizations.of(context).getText(
                              'dlozsnib' /* Autre */,
                            )
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'ulcpehnj' /* Fixer un prix (obligatoire) */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnWidget(
                  ...
                  cateogryName: 'Déménagement & Montage',
                  categoryImage:
