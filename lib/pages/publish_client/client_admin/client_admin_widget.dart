                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'qhed8k6h' /* Service administratif */,
                        ),
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              ...
                              FFLocalizations.of(context).getText(
                                'ab89dmed' /* Permis de travail */,
                              ),
                              FFLocalizations.of(context).getText(
                                'dj8jen2s' /* Papiers administratifs */,
                              ),
                              FFLocalizations.of(context).getText(
                                '9ibwj3rm' /* Autre */,
                              )
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'tad5kp06' /* Nombre d’années d’expériences ... */,
                                ),
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'tk9erbnd' /* Fixer un prix (obligatoire) */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnWidget(
                  ...
                  parameter2: _model.descTextController.text,
                  parameter3: _model.priceTextController.text,
                  parameter4: _model.otherTextController.text,
                  publishDoc: widget.publishDoc,
                  cateogryName: 'Service administratif',
                  categoryImage:
                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/mitiim-project-u-k-q0nma8/assets/plca5dyc2rf7/CatAdmiCircleNoAct.png',
                ),
              ),
            ),
          ],
