...
import 'client_it_service_model.dart';
export 'client_it_service_model.dart';

class ClientItServiceWidget extends StatefulWidget {
  const ClientItServiceWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ClientItServiceWidget> createState() => _ClientItServiceWidgetState();
}

class _ClientItServiceWidgetState extends State<ClientItServiceWidget> {
  late ClientItServiceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientItServiceModel());
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          's49scxwn' /* Service informatique / Câblage */,
                        ),
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          options: [
                            ...
                            FFLocalizations.of(context).getText(
                              'oegpmxee' /* Dépannage (logiciel & matériel... */,
                            ),
                            FFLocalizations.of(context).getText(
                              'ap8xunpl' /* CCTV */,
                            ),
                            FFLocalizations.of(context).getText(
                              '0my8wnkd' /* Air conditionné */,
                            ),
                            FFLocalizations.of(context).getText(
                              'burplgy5' /* Sécurité */,
                            ),
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                '3qir685v' /* Recherche Femme/Homme (Tranche... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'ty9y8tr6' /* Fixer un prix (obligatoire) */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnWidget(
                  ...
                  cateogryName: 'Installation & SAV informatique',
                  categoryImage:
