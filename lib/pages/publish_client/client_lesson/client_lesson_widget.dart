...
import 'client_lesson_model.dart';
export 'client_lesson_model.dart';

class ClientLessonWidget extends StatefulWidget {
  const ClientLessonWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ClientLessonWidget> createState() => _ClientLessonWidgetState();
}

class _ClientLessonWidgetState extends State<ClientLessonWidget> {
  late ClientLessonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientLessonModel());
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          options: [
                            ...
                            FFLocalizations.of(context).getText(
                              '6s64x2lg' /* Mathématiques */,
                            ),
                            FFLocalizations.of(context).getText(
                              '49in7plk' /* les sciences */,
                            ),
                            FFLocalizations.of(context).getText(
                              '02t0oo18' /* Musique */,
                            ),
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'l9mb67n8' /* Recherche Femme/Homme (Tranche... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'jw41nsrm' /* Fixer un prix (obligatoire) */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnWidget(
                  ...
                  cateogryName: 'Cours particuliers',
                  categoryImage:
