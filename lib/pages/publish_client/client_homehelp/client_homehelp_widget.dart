...
import 'client_homehelp_model.dart';
export 'client_homehelp_model.dart';

class ClientHomehelpWidget extends StatefulWidget {
  const ClientHomehelpWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ClientHomehelpWidget> createState() => _ClientHomehelpWidgetState();
}

class _ClientHomehelpWidgetState extends State<ClientHomehelpWidget> {
  late ClientHomehelpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientHomehelpModel());
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          options: [
                            ...
                            FFLocalizations.of(context).getText(
                              '9flanc2w' /* Soin à domicile (lessive, cour... */,
                            ),
                            FFLocalizations.of(context).getText(
                              '51sh8tcv' /* Jardinnage */,
                            ),
                            ...
                            FFLocalizations.of(context).getText(
                              'ocjech10' /* Gardiannage */,
                            ),
                            FFLocalizations.of(context).getText(
                              'kmubi23h' /* Garde d'enfants */,
                            ),
                            FFLocalizations.of(context).getText(
                              'pnucioyf' /* Autre */,
                            )
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                '4whk5iom' /* Recherche Femme/Homme (Tranche... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'gwmeo2if' /* Fixer un prix (obligatoire) */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnWidget(
                  ...
                  cateogryName: 'Aide à domicile & Entreprise',
                  categoryImage:
