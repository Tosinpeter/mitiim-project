...
import 'client_construction_model.dart';
export 'client_construction_model.dart';

class ClientConstructionWidget extends StatefulWidget {
  const ClientConstructionWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ClientConstructionWidget> createState() =>
      _ClientConstructionWidgetState();
}

class _ClientConstructionWidgetState extends State<ClientConstructionWidget> {
  late ClientConstructionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientConstructionModel());
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'gaijiisb' /* Construction / Maintenance */,
                        ),
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'czl4fo5x' /* Nombre d’années d’expériences ... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    '3he47enc' /* Fixer un prix (obligatoire) */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnWidget(
                  ...
                  cateogryName: 'Construction & Petits travaux',
                  categoryImage:
                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/mitiim-project-u-k-q0nma8/assets/9xaebzwsm1vh/CatConstCircleNoAct.png',
                ),
              ),
            ),
          ],
