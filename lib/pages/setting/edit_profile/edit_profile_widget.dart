...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.displayNameTextController1?.text = currentUserDisplayName;
        _model.displayNameTextController1?.selection = TextSelection.collapsed(
            offset: _model.displayNameTextController1!.text.length);
      });
      setState(() {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text: FFLocalizations.of(context).getText(
                              '3nxkztcd' /* Télécharger ou modifier une ph... */,
                            ),
                            icon: const Icon(
                                ...
                                builder: (context) => Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      Align(
                                        alignment:
                                            const AlignmentDirectional(1.05, 1.04),
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await currentUserReference!
                                                .update(createUsersRecordData(
                                              photoId3: _model.uploadedFileUrl2,
                                            ));
                                          },
                                        ),
                                      ),
                                ...
                                builder: (context) => Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      Align(
                                        alignment:
                                            const AlignmentDirectional(1.07, 1.02),
                                        child: FlutterFlowIconButton(
                                          borderColor: const Color(0x00FFFFFF),
                                          borderRadius: 20.0,
                                          buttonSize: 40.0,
                                          ...
                                          onPressed: () async {
                                            ...
                                            await currentUserReference!
                                                .update(createUsersRecordData(
                                              photoId4: _model.uploadedFileUrl3,
                                            ));
                                          },
                                        ),
                                      ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'ill2x3xa' /* Confirmer nouveau mot de passe */,
                              ),
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (_model.displayNameTextController1.text !=
                                      '') {
                                await currentUserReference!
                                    .update(createUsersRecordData(
                                  displayName:
                              ...
                              if (_model.addressTextController.text != '') {
                                await currentUserReference!
                                    .update(createUsersRecordData(
