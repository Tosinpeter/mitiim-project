...
import 'edit_languages_model.dart';
export 'edit_languages_model.dart';

class EditLanguagesWidget extends StatefulWidget {
  const EditLanguagesWidget({super.key});

  @override
  State<EditLanguagesWidget> createState() => _EditLanguagesWidgetState();
}

class _EditLanguagesWidgetState extends State<EditLanguagesWidget> {
  late EditLanguagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditLanguagesModel());
