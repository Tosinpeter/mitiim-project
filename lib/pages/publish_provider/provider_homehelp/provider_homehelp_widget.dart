...
import 'provider_homehelp_model.dart';
export 'provider_homehelp_model.dart';

class ProviderHomehelpWidget extends StatefulWidget {
  const ProviderHomehelpWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ProviderHomehelpWidget> createState() => _ProviderHomehelpWidgetState();
}

class _ProviderHomehelpWidgetState extends State<ProviderHomehelpWidget> {
  late ProviderHomehelpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderHomehelpModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          options: [
                            ...
                            FFLocalizations.of(context).getText(
                              'a1jnbbcq' /* Soin à domicile (lessive, cour... */,
                            ),
                            FFLocalizations.of(context).getText(
                              'y9qr3kbc' /* Jardinnage */,
                            ),
                            ...
                            FFLocalizations.of(context).getText(
                              '34o9vdnd' /* Gardiannage */,
                            ),
                            FFLocalizations.of(context).getText(
                              '6w1pz8yi' /* Garde d'enfants */,
                            ),
                            FFLocalizations.of(context).getText(
                              'cmm7c9di' /* Autre */,
                            )
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '2lvtdo3s' /* Précisez vos Compétences */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .titleLarge
                              .override(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'z8w63pj6' /* Nombre d’années d’expériences.... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnProviderWidget(
                  ...
                  categoryName: 'Aide à domicile & Entreprise',
                  categoryImage:
                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/mitiim-project-u-k-q0nma8/assets/8vb7tik0o8tv/CatAideCircleNoAct.png',
                ),
              ),
            ),
          ],
