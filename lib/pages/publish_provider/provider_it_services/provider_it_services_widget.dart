...
import 'provider_it_services_model.dart';
export 'provider_it_services_model.dart';

class ProviderItServicesWidget extends StatefulWidget {
  const ProviderItServicesWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ProviderItServicesWidget> createState() =>
      _ProviderItServicesWidgetState();
}

class _ProviderItServicesWidgetState extends State<ProviderItServicesWidget> {
  late ProviderItServicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderItServicesModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'g3ta5g8o' /* Service informatique / Câblage */,
                        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          options: [
                            ...
                            FFLocalizations.of(context).getText(
                              's9t84ocd' /* Dépannage (logiciel & matériel... */,
                            ),
                            FFLocalizations.of(context).getText(
                              '2we8ipuo' /* CCTV */,
                            ),
                            FFLocalizations.of(context).getText(
                              'vaqlbgtd' /* Air conditionné */,
                            ),
                            FFLocalizations.of(context).getText(
                              '8eww8nl8' /* Sécurité */,
                            ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'eni4ziqa' /* Précisez vos compétences */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .titleLarge
                              .override(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'tt6folxg' /* Nombre d’années d’expériences.... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
            ...
            Align(
              ...
              child: wrapWithModel(
                ...
                child: PublishBtnProviderWidget(
                  ...
                  categoryName: 'Installation & SAV informatique',
                  categoryImage:
                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/mitiim-project-u-k-q0nma8/assets/kleih48xgf9x/CatSavCircleNoAct.png',
                ),
              ),
            ),
          ],
