...
import 'provider_beauty_model.dart';
export 'provider_beauty_model.dart';

class ProviderBeautyWidget extends StatefulWidget {
  const ProviderBeautyWidget({
    super.key,
    this.publishDoc,
  });
  ...
  @override
  State<ProviderBeautyWidget> createState() => _ProviderBeautyWidgetState();
}

class _ProviderBeautyWidgetState extends State<ProviderBeautyWidget> {
  late ProviderBeautyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderBeautyModel());
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                options: [
                                  FFLocalizations.of(context).getText(
                                    '2a8u0k5d' /* Coiffure (coupe, coloration) */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'aiiehwgq' /* Maquillage */,
                                  ),
                                  ...
                                  FFLocalizations.of(context).getText(
                                    '1jdir9oz' /* Extension de cils */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'in7wyryq' /* Soin du visage */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'wyvcvi6l' /* Autre */,
                                  )
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'tgw83mt8' /* Précisez vos compétences */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleLarge
                                    .override(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'e9ffhz4m' /* Nombre d’années d’expériences.... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
