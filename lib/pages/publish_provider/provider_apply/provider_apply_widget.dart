...
import 'provider_apply_model.dart';
export 'provider_apply_model.dart';

class ProviderApplyWidget extends StatefulWidget {
  const ProviderApplyWidget({
    super.key,
  ...
  @override
  State<ProviderApplyWidget> createState() => _ProviderApplyWidgetState();
}

class _ProviderApplyWidgetState extends State<ProviderApplyWidget> {
  late ProviderApplyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderApplyModel());
        ...
        body: SafeArea(
          ...
          child: Align(
            ...
            child: StreamBuilder<UsersRecord>(
              stream: UsersRecord.getDocument(widget.publishDoc!.userRef!),
                          ...
                          child: Stack(
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed('Profil_presta');
                                },
                                child: Container(
                                  width: 90.0,
                                  height: 90.0,
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      3.0),
                                                          child: Text(
                                                            '${widget.publishDoc?.price.toString()} K',
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await notificationRecordReference
                                          ...
                                          title:
                                              '${columnUsersRecord.displayName} applied for${widget.publishDoc?.name}',
                                          madeBy: PublishedBy.provider,
                                        ));
                                        _model.notif = NotificationRecord
                                            .getDocumentFromData(
                                                createNotificationRecordData(
                                                  createdDate:
                                                      getCurrentTimestamp,
                                                  publishRef: widget
                                                      .publishDoc?.reference,
                                        ...
                                        triggerPushNotification(
                                          ...
                                          notificationText:
                                              '$currentUserDisplayName responded to your ad.',
