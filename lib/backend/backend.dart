...
/// Functions to query PublishRecords (as a Stream and as a Future).
Future<int> queryPublishRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PublishRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PublishRecord>> queryPublishRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PublishRecord.collection,
      PublishRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PublishRecord>> queryPublishRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query PublishsRecords (as a Stream and as a Future).
Future<int> queryPublishsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PublishsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PublishsRecord>> queryPublishsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PublishsRecord.collection,
      PublishsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PublishsRecord>> queryPublishsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
