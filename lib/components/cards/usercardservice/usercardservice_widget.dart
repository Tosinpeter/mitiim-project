...
import 'usercardservice_model.dart';
export 'usercardservice_model.dart';

class UsercardserviceWidget extends StatefulWidget {
  const UsercardserviceWidget({
    super.key,
  ...
  @override
  State<UsercardserviceWidget> createState() => _UsercardserviceWidgetState();
}

class _UsercardserviceWidgetState extends State<UsercardserviceWidget> {
  late UsercardserviceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UsercardserviceModel());
