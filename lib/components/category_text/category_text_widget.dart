...
import 'category_text_model.dart';
export 'category_text_model.dart';
...
class _CategoryTextWidgetState extends State<CategoryTextWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryTextModel());
    ...
    return Stack(
      children: [
        ...
        if (widget.category == PublishCategory.IT)
          Text(
            FFLocalizations.of(context).getText(
              'xj8zzums' /* Service informatique / Câblage */,
            ),
            style: FlutterFlowTheme.of(context).bodyMedium.override(
                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                  fontSize: 16.0,
        ...
        if (widget.category == PublishCategory.Administrative)
          Text(
            FFLocalizations.of(context).getText(
              'ydhxhnj6' /* Service administratif */,
            ),
            style: FlutterFlowTheme.of(context).bodyMedium.override(
                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                  fontSize: 16.0,
        ...
        if (widget.category == PublishCategory.Construction)
          Text(
            FFLocalizations.of(context).getText(
              'e38t3asf' /* Construction / Maintenance */,
            ),
            style: FlutterFlowTheme.of(context).bodyMedium.override(
                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                  fontSize: 16.0,
